...
/// Constructs a MultiSwapper from CapLimitedSwapper instances and calls quoteOut.
///
...
access(all) fun main(
    ...
    return multiSwapper.quoteOut(forProvided: forProvided, reverse: reverse) as! SwapConnectors.MultiSwapperQuote
}
